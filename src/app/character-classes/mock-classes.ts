...
export const CHARACTERCLASSES: characterClass[] = [
    {
      ...
      inventorycselections: ['any polearm', 'any long blade', 'two handaxes', 'any short blade'],
    ...
    },
    {
      ...
      inventorycselections: ['rapier', 'longsword', 'diplomat pack', 'entertainer pack', 'lute', 'non-lute musical instrument'],
